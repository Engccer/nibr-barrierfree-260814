...
NARRATIONS = {
    ...
    2: "오늘 나눌 이야기. 네 가지",
    3: "내가 만난 세상. 자기소개 영상",
    4: "내가 세상과 소통하는 두 가지 방식",
    5: "여가가 아니라 학습이었다",
    6: "배제하는 가이드와 포용하는 가이드",
    7: "뮤지엄 산. 낙오된 관람객",
    8: "필링 반 고흐. 시각장애인을 위한 프로그램",
    9: "나탈리의 해설. 양각 자료와 팔레트 모형",
    10: "나탈리가 한 일. 여섯 가지",
    11: "능숙하게 설명하는 가이드. 영상",
    12: "촉각 자료를 손에 쥐여 주었다. 영상",
    13: "그림 앞에 나를 앉혔다. 사진",
    14: "사람들이 모여들었다. 한 시간 사십 분",
    15: "어느 수집가의 초대. 국립중앙박물관",
    16: "전시의 설계도를 말로 건네받다",
    17: "세 곳의 차이. 전달하는 방식과 태도",
    18: "촉각 경험의 의미. 핸즈 온 익스피리언스",
    19: "촉감은 존재를 증언한다",
    20: "건축 모형. 쾰른과 안트워프",
    21: "이동에 쓰는 지도. 반 고흐 미술관 로비",
    22: "점자 범례가 붙어 있었다. 영상",
    23: "교육 시설일수록 아쉽다. 촉지도",
    24: "경기장의 소장품. 축구화",
    25: "주목할 것은 절차였다",
    26: "소리를 촉감으로 느끼다. 공간 사이",
    27: "몸으로 알게 되었다. 청음 의자와 진동",
    28: "점자가 새겨진 카드. 함께 놀 권리",
    29: "촉각은 독립된 인식의 경로다",
    30: "한 학생을 위한 설계, 모든 학생을 위한 수업",
    31: "설계 단계의 접근성. 포용성과 몰입감",
    32: "보편적 학습 설계와 다중 감각 구현",
    33: "워드 밤. 공강 삼십 분에 만든 어휘 게임",
    34: "픽 미. 수업 운영 도구",
    35: "학생들의 평가. 백오십오 명 익명 설문",
    36: "더 자주 하자는 응답. 구십이 점 구 퍼센트",
    37: "학습자 다양성의 증거",
