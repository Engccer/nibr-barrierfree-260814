...
NARRATIONS = {
    ...
    35: "학습자 다양성의 증거",
    36: "생물다양성교실에 적용할 수 있는 다섯 가지",
    37: "하나. 교육 시작 전에 먼저 물어보세요",
    38: "둘. 준비한 것은 빠짐없이 말로 설명해 주세요",
    39: "셋. 화면 속 모양을 몸으로 따라 하게 해 주세요",
    40: "넷. 활동을 바꾸지 말고 순서를 하나만 더 넣어 주세요",
    41: "다섯. 만져도 되는 표본을 미리 골라 알려 주세요",
    42: "다음 회차에도 다시 쓰인다",
    43: "두 가지 기술이 따로 있지 않다",
    44: "그냥 좋은 해설이었다",
    45: "마지막으로 남기고 싶은 한 문장",
    46: "공개해 둔 것. 링크 세 가지",
}
